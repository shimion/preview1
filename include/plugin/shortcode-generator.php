<?php
	...
	function gdl_list_shortcode( $atts, $content = null ){
		extract( shortcode_atts(array("type" => 'icon-angle-right', "color"=>''), $atts) );	
		global $gdl_type; $gdl_type = $type;
		global $gdl_list_color; $gdl_list_color = empty($color)? '': ' style="color: ' . $color . ';" ';
	...
	function gdl_li_shortcode( $atts, $content = null ){
		extract( shortcode_atts(array(), $atts) );	
		global $gdl_type, $gdl_list_color;
		
		return '<li><i class="' . $gdl_type . '" ' . $gdl_list_color . '></i>' . $content . '</li>';
	}	
	...
	function fix_shortcodes($content){   
		...
		$shortcode_tags = array(
			'gdlr_paypal' => 'gdlr_paypal_shortcode', 'last_minute_deal' => 'gdl_last_minute_deal_shortcode', 'price_list' => 'gdl_price_list_shortcode', 'price_content' => 'gdl_price_content_shortcode', 'column_service' => 'gdl_column_service_shortcode', 'accordion' => 'gdl_accordion_shortcode', 'acc_item' => 'gdl_acc_item_shortcode', 'quote' => 'gdl_quote_shortcode', 'button' => 'gdl_button_shortcode', 'column' => 'gdl_column_shortcode', 'divider' => 'gdl_divider_shortcode', 'dropcap' => 'gdl_dropcap_shortcode', 'gdl_gallery' => 'gdl_gallery_shortcode', 'list' => 'gdl_list_shortcode', 'li' => 'gdl_li_shortcode', 'gdl_icon' => 'gdl_icon_shortcode', 'message_box' => 'gdl_message_box_shortcode', 'personnel' => 'gdl_personnal_shortcode', 'price-item' => 'gdl_price_item_shortcode', 'progress_bar' => 'gdl_progress_bar', 'social' => 'gdl_social_shortcode', 'space' => 'gdl_space_shortcode', 'tab' => 'gdl_tab_shortcode', 'tab_item' => 'gdl_tab_item_shortcode', 'testimonial' => 'gdl_testimonial_shortcode', 'toggle_box' => 'gdl_toggle_box_shortcode', 'toggle_item' => 'gdl_toggle_item_shortcode', 'vimeo' => 'gdl_vimeo_shortcode', 'youtube' => 'gdl_youtube_shortcode'
		);
